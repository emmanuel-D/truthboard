...
- [ ] A filter bar (text search over title/id, epic chips, owner) narrows
...
- [ ] Columns scroll independently so the board itself fits the viewport
- [ ] Epic tags carry a stable color dot — fixed assignment from a
